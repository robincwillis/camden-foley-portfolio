...
function NextArrow(props) {
    ...
    return (
        <div
            className={clsx(`border-l transition-all h-full w-[55px] cursor-pointer flex items-center justify-center`, {
...
function PrevArrow(props) {
    ...
    return (
        <div
            className={clsx(`border-r transition-all h-full w-[55px] cursor-pointer flex items-center justify-center`, {
                "bg-black fill-white border-white" : currentSlide === 0,
                "bg-white fill-black border-black" : currentSlide !== 0,
            })}
            style={{
